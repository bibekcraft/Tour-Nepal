  ...
  return (
    <div className="bg-gray-100 font-poppins">
      ...
      <div className="py-16 text-center">
        <h2 className="text-5xl font-bold">Find Your Perfect Car</h2>
        <p className="mt-4 text-lg text-gray-500">
          Explore our wide range of cars for your journey.
        </p>
        ...
        <div className="inline-block p-10 mt-16 bg-white rounded-lg shadow-xl">
          <div className="flex items-center space-x-10">
            <div>
              <label className="block text-lg font-semibold">Pick-up / Drop-off</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-lg font-semibold">Check in</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-lg font-semibold">Check out</label>
              <input
                type="date"
                className="w-48 p-3 mt-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-black"
              />
