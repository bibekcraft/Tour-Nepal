...
const NepalTitle = () => {
  return (
    ...
    >
      {/* Semi-transparent overlay for aesthetic feel */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-rose-100 to-rose-300 opacity-60"></div>

      {/* Nepal Text with background image */}
      <div
        className="relative z-10 text-[12rem] md:text-[15rem] lg:text-[18rem] font-extrabold uppercase text-transparent bg-clip-text animate-fadeIn"
        style={{
      ...
      <div className="relative z-10 mt-4 text-center animate-fadeInUp">
        ...
        <h2 className="text-2xl font-bold text-gray-700 md:text-3xl lg:text-4xl">Nepal Tourism Board</h2>
      </div>
    </div>
  );
};
