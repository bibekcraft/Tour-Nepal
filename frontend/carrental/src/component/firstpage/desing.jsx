...
const Design = () => {
    ...
    return (
        <div className="relative w-full h-screen">
            ...
            {/* Thumbnail Section */}
            <div
                className="absolute flex flex-col items-center gap-4 transform -translate-y-1/2 top-1/2 right-5"
            >
                {thumbnails.map((thumb, index) => (
                    <div
                        ...
                        className={`
                            ...
                            ${activeThumbnail === index ? 'border-orange-500' : 'border-transparent'}
