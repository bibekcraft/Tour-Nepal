...
function Recommendations() {
  return (
    <div><section className="max-w-screen-xl px-6 py-10 mx-auto">
    ...
    <div>
      ...
      <div className="flex items-center p-6 mt-6 rounded-lg shadow-lg bg-gray-50">
        ...
        <div className="ml-6">
          ...
          <p className="mt-2 text-gray-600">
            With over 10 years of experience in guiding tourists around the Himalayan region, Rajesh is known for his detailed knowledge and friendly approach. Whether youre a trekker or simply exploring, Rajesh will make your journey unforgettable.
          </p>
        </div>
      </div>
    </div>
